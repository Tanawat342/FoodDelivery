<footer id="footer">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 footer-col">
                    <div class="block text">
                        <div class="block-content">
                            <a href="home/home-2.html" class="logo-footer">
                                <img src="home/img/logo-2.png" alt="Logo">
                            </a>
    ...
    <div class="footer-copyright text-center">
        <div class="container">
            <div class="copyright"><a target="_blank" href="https://www.templateshub.net">Food Delivery @ Copyright</a></div>
        </div>
    </div>
    </div>
</footer>